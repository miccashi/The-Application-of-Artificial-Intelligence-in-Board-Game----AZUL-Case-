...
from state_monitor import increase_actions
...
class MI_PlayerAll(RewardBasedPlayer):
...
class Mcts_search:
    ...
    def search(self, moves, game_state, player_order, original_moves):
        ...
        self.FIRST_SEARCH = 400 // move_len
        self.FOE_SEARCH = self.FIRST_SEARCH // 2
    ...
    def get_pre_prob(self, game_state, moves, act_id, player_order):
        ...
        #threshold_most = FOE_SEARCH if len(self.tree) != 1 else FIRST_SEARCH
        # threshold_impo = 4
